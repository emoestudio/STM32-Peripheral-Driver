...
/* Select a display direction */
#define ILI9341_DISPLAY_DIRECTION       1
...
#if ILI9341_DISPLAY_DIRECTION == 0
...
// rotate right
#if ILI9341_DISPLAY_DIRECTION == 1
...
// rotate left
#if ILI9341_DISPLAY_DIRECTION == 2
    #define ILI9341_WIDTH  320
    #define ILI9341_HEIGHT 240
...
// upside down
#if ILI9341_DISPLAY_DIRECTION == 3
    #define ILI9341_WIDTH  240
    #define ILI9341_HEIGHT 320
